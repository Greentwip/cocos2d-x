...
int lua_cocos2dx_studio_ActionFrame_getAction(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 2) {
            ...
            if (!ok) { break; }
            cocostudio::ActionFrame* arg1 = nullptr;
...
int lua_cocos2dx_studio_FrameData_copy(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        const cocostudio::BaseData* arg0 = nullptr;
...
int lua_cocos2dx_studio_MovementBoneData_addFrameData(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        cocostudio::FrameData* arg0 = nullptr;
...
int lua_cocos2dx_studio_ActionTimelineNode_init(lua_State* tolua_S)
{
    ...
    {
        cocos2d::Node* arg0 = nullptr;
        cocostudio::timeline::ActionTimeline* arg1 = nullptr;
